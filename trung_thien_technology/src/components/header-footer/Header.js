                            ...
                            >
                                ...
                                <div className="header-action-item main-header--ordertracking hide-mb">
                                    <div className="header-action_text">
                                        {isLogin ?
                                            role === "ROLE_CUSTOMER" ?
                                                <NavLink to="/order-history" className="header-action__link js-account"
								...
								<span className="box-icon">
									...
									<span className="txtbl"><span className="txt-overflow"><span>đơn hàng</span></span></span>
                                                ...
                                                : "" :
                                            <NavLink to="/login" className="header-action__link js-account"
                                                        ...
                                                        role !== "ROLE_ADMIN" ?
                                                            <>
                                                                <div className="d-block">
                                                                    <div className="thing">
                                                                        <NavLink to={"/"}><ion-icon name="clipboard-outline"/>Thông tin khách hàng</NavLink>
                                                                    </div>
                                                                    <button className="js-account"
                                                                            onClick={async () => (
                                                                                await saveShoppingCart() ,
                                                                                    ...
                                                                                    await handlerLogout())}
                                                                    ><span style={{marginRight:"5px",fontSize:"17px"}}><ion-icon name="log-out-outline"/></span><span>ĐĂNG XUẤT</span>
                                                                    </button>
                                                                </div>
                                                            </>
                                                            :
